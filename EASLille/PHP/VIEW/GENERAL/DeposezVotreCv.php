...
<div class="espace"></div>
        ...
        <div>
            ...
            <INPUT type="text" id="email" name="email" placeholder="monadresse@gmail.com" required
            value="<?php if (
...
<div class="espace"></div>
        ...
        <div>
            ...
            <INPUT type="text" id="telephone" name="telephone" placeholder="06/23/89/85/21" required
            value="<?php if (
...
<div class="espace"></div>
        ...
        <div>
            ...
            <INPUT type="text" id=" situationProfessionnelle" name="situationProfessionnelle" placeholder=" comptable" required
            value="<?php if (
        ...
        <!-- </div> -->
         <div>
           <!-- <input type="button" id="btn" name="deposez votre lettre de motivation"   value="Download" />  -->
            ...
            <INPUT type="file" id="fichier" name="fichier" accept=".doc,.pdf,.docx,.xml" 
            value="<?php if (
isset($_POST['fichier'])) echo htmlspecialchars($_POST['fichier']);?>"> 
<div class="espace"></div>
<div class="espace"></div>
        ...
        <div>
            ...
            <textarea id="message" name="message" placeholder="Lettre de motivation...." required 
            value="<?php if (
isset($_POST['message'])) echo htmlspecialchars($_POST['message']);?>"> 
