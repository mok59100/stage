...
echo '<div class="caseListe labelListe">TelephoneUtilisateur</div>';
echo '<div class="caseListe labelListe">SituationProfessionnelle</div>';
echo '<div class="caseListe labelListe">Active</div>';
echo '<div class="caseListe labelListe">IdRole</div>';
...
echo '<div class="caseListe donneeListe">'.$unObjet->getTelephoneUtilisateur().'</div>';
echo '<div class="caseListe donneeListe">'.$unObjet->getSituationProfessionnelle().'</div>';
echo '<div class="caseListe donneeListe">'.$unObjet->getActive().'</div>';
echo '<div class="caseListe donneeListe">'.$unObjet->getIdRole().'</div>';
